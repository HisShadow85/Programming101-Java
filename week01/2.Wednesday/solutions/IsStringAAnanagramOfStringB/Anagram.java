...
public class Anagram {
	...
	public static void main(String[] args) {
		...
		System.out.println(anagram("abvgteaklsndakjsajsbhjasbajAFASFDFBTUTT","abvgteaklsndakjsajsbhjasbajAFASFDFBTUTT"));
	...
	static boolean anagram(String A, String B) {
		...
		for (int i = 0; i < B.length(); i++) {
			if (!Character.isWhitespace(B.charAt(i))) {
				if (!chs.remove(Character.toLowerCase(B.charAt(i)))) {
					return false;
				}
			}
		}
